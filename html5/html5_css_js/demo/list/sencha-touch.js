...
Ext.util.Stateful = Ext.extend(Ext.util.Observable, {
    ...
    copy: function(a) {
        ...
        this[this.persistanceProperty]), a || this.internalId)
    }
});
...
Ext.ModelMgr = new Ext.AbstractManager({
    ...
    createAssociations: function(e, b) {
        var f = e.length,
        d, c, a;
        c = new Ext.util.MixedCollection(false,
        function(g) {
            return g.name
        });
        for (d = 0; d < f; d++) {
    ...
    createFields: function(a) {
        var d = a.length,
        c, b;
        b = new Ext.util.MixedCollection(false,
        function(e) {
            return e.name
        });
        for (c = 0; c < d; c++) {
...
Ext.data.Proxy = Ext.extend(Ext.util.Observable, {
    ...
    batch: function(b, c) {
        ...
        Ext.each(this.batchOrder.split(","),
        function(d) {
            if (b[d]) {
    ...
    createRequestCallback: function(d, a, e, b) {
        ...
        return function(o, n, h) {
            if (n === true) {
                ...
                g = p.records,
                f = g.length,
                m = new Ext.util.MixedCollection(true,
                function(i) {
                    return i.getId()
                }),
                k,
...
Ext.regApplication = function() {
    ...
    c.fly = function(f, d) {
        ...
        d = d || "_global";
        f = Ext.getDom(f);
        if (f) { (c._flyweights[d] = c._flyweights[d] || new c.Flyweight()).dom = f;
            e = c._flyweights[d]
        }
        return e
    };
...
Ext.CompositeElement.prototype.on = Ext.CompositeElement.prototype.addListener; (function() {
...
Ext.util.Droppable = Ext.extend(Ext.util.Observable, {
    ...
    Ext.util.ScrollView = Ext.extend(Ext.util.Observable, {
        ...
        constructor: function(b, a) {
            ...
            Ext.util.ScrollView.superclass.constructor.call(this); ["useIndicators", "indicatorConfig", "indicatorMargin"].forEach(function(e) {
            ...
            c.forEach(function(e) {
                this.indicators[e] = new Ext.util.Scroller.Indicator(this.scroller.container, Ext.apply({},
    ...
    Ext.util.Scroller = Ext.extend(Ext.util.Draggable, {
        ...
        startMomentumAnimation: function(g) {
            ...
            this.momentumAnimationStartOffset = h; ["x", "y"].forEach(function(e) {
...
Ext.util.EventSimulator = Ext.extend(Object, {
    ...
    getEventTypeByName: function(b) {
        var a = null;
        Ext.iterate(this.supportedEvents,
        function(d, c) {
            if (c.indexOf(b) != -1) {
                a = d
            }
...
Ext.util.EventRecorder = Ext.extend(Ext.util.Observable, {
    ...
    replay: function(c, j) {
        ...
        h,
        f,
        a = ["touchmove", "touchend", "mousemove", "mouseup"],
        g = this;
        ...
        if (this.rendered) {
            if (a === false) {
                ...
                if (this.dragObj) {
                    ...
                    this.dragObj = new Ext.util.Draggable(this.el, Ext.apply({},
                    this.draggable || {}));
...
Ext.List = Ext.extend(Ext.DataView, {
    ...
    afterRender: function() {
        ...
        if (this.indexBar) {
            this.indexBar = new Ext.IndexBar(Ext.apply({},
            Ext.isObject(this.indexBar) ? this.indexBar: {},
            {
                xtype: "indexbar",
                alphabet: true,
                renderTo: this.el
...
Ext.TabPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        this.layout = null;
        this.setLayout(a);
        this.tabBar = new Ext.TabBar(Ext.apply({},
        this.tabBar || {},
        {
            cardLayout: a,
...
Ext.Carousel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        if (this.indicator) {
            ...
            this.indicator = new Ext.Carousel.Indicator(Ext.apply({},
            a, {
                direction: this.direction,
                carousel: this,
                ui: this.ui
...
Ext.Carousel.Indicator = Ext.extend(Ext.Component, {
    ...
    onRender: function() {
        ...
        for (var a = 0,
        b = this.carousel.items.length; a < b; a++) {
    ...
    submit: function(a) {
        ...
        if (this.fireEvent("beforesubmit", this, c, a) !== false) {
            ...
            return Ext.Ajax.request({
                url: a.url,
                method: a.method,
                rawData: Ext.urlEncode(Ext.apply(Ext.apply({},
                this.baseParams || {}), a.params || {},
                c)),
