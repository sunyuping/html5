//
//  RNWebViewJavascriptBridge.m
//  html5
//
//  Created by 玉平 孙 on 12-2-5.
//  Copyright (c) 2012年 __MyCompanyName__. All rights reserved.
//

#import "RNWebViewJavascriptBridge.h"

//@implementation RNWebViewJavascriptBridge

//@end


@interface RNWebViewJavascriptBridge ()
...
+ (id)javascriptBridgeWithDelegate:(id <WebViewJavascriptBridgeDelegate>)delegate {
    RNWebViewJavascriptBridge* bridge = [[[RNWebViewJavascriptBridge alloc] init] autorelease];
